...
import indexData from '../assets/ResourceIndex.json';
import treeData from '../assets/resource.json';
...
const horizontalBarData = ref([
    { name: '更新淘汰能力', value: 0.05 },
    { name: '创新产量', value: 6 },
    { name: '产出数量', value: 17 },
    { name: '数字资源竞争程度', value: 1.96839 },
    { name: '构件层级深度', value:  4}
]);
...
const smallBarData3 = ref(indexData.S);
...
const initBarChart = (name) => {
    // 从indexData中的index对象中获取name对应的数据
